...
<template>
  <div id="main" class="absolute h-[1080px] w-[1920px] text-white">
    ...
    <div id="atk" v-show="teamInfo.showAtk" class="absolute top-0 left-0 flex flex-row w-full justify-between px-[62px] py-[130px] text-[20px] font-lexend-black">
    ...
    <div id="footer" class="relative bottom-0 flex h-[204px] w-full px-[20px]">
      ...
      >
        <div
          id="reversed-score-bar"
          class="absolute top-0 h-[20px] transition-[width] duration-500 ease-out"
          :style="reversedScoreBarStyle(scoreInfo.BarWidth, scoreInfo.BorderWidth)"
        ></div>

        <div
          id="extended-score-bar"
          class="absolute top-0 h-[20px] transition-[width] duration-500 ease-out"
          :style="extendedScoreBarStyle(scoreInfo.BarWidth, scoreInfo.BorderWidth)"
        ></div>

        <div
          id="score-bar"
          class="absolute top-0 h-[20px] bg-white transition-[width] duration-500 ease-out"
          :style="scoreBarStyle(scoreInfo.BarWidth)"
        ></div>
      ...
      >
        <img id="map-bg" class="relative top-0 h-[102px] w-[400px] object-cover object-center" :src="mapInfo.BGUrl" />
