  ...
  <div id="app" class="flex min-h-screen w-[1920px] flex-col text-slate-100">
    <div id="main" class="flex justify-center">
      <div class="relative h-[1080px] w-[1920px] bg-black">
        <pre
          id="game-status"
          class="absolute left-3 top-3 h-[1080px] w-[560px] whitespace-pre-wrap text-[18px] text-white truncate"
          >{{ gameStatusText }}</pre
        >
        <pre
          id="game-event"
          class="absolute left-[600px] h-[1080px] top-3 w-[560px] whitespace-pre-wrap text-[18px] text-white truncate"
          >{{ gameEventText }}</pre
        >
      </div>
    </div>
    ...
    <div
      class="flex w-[1920px] flex-wrap items-center justify-between gap-3 bg-slate-800 px-4 py-3 text-[30px]"
    >
