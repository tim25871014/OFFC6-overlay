...
<template>
  <div id="main" class="absolute h-[1080px] w-[1920px] text-white">
    ...
    <div id="content" class="h-[720px] w-full flex flex-col items-center gap-5 mt-5">
      ...
      <div
        class="w-[1200px] h-[85px] bg-linear-to-r flex items-center justify-center"
        :class="
          winner == 'red'
      ...
      <div class="w-full h-full flex gap-16 justify-center">
        <div class="w-[520px] h-full relative">
          <div
            class="absolute top-0 left-0 size-[35px] rounded-full animate-pulse"
            :class="
              winner == 'red'
                ? 'bg-[#ff9d8e]'
                : winner === 'blue'
          ...
          <div
            class="absolute top-[14px] left-[14px] w-[502px] h-[387px] border-[12px] rounded-[76px]"
            :class="
              winner == 'red'
                ? 'border-[#cc7066]'
                : winner === 'blue'
          ...
          <svg width="502" height="387" viewBox="-6 -6 502 387" class="absolute top-[14px] left-[14px]">
            <rect
              ...
              stroke-dasharray="1610 1610"
              :stroke="winner == 'red' ? '#ff9d8e' : winner === 'blue' ? '#96bcff' : '#555555'"
              style="animation: snake 3s ease-in-out infinite"
            />
          </svg>
          <div
            class="absolute top-[375px] left-[500px] size-[35px] rounded-full animate-pulse"
            :class="
              winner == 'red'
                ? 'bg-[#ff9d8e]'
                : winner === 'blue'
