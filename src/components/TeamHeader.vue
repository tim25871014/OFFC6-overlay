      ...
      >
        ...
        <div :class="['flex flex-col gap-1', team.nameAlign]">
          ...
          <div :class="['relative w-[250px] h-[44px] transform', team.hpBarClass]">
            <div
              class="absolute size-[100%] rounded-[10px] transition-[width] duration-300 ease-out"
              :style="{
                transform: team.skew,
                right: team.hpRight,
            ...
            ></div>
            <div
              class="absolute size-[100%] rounded-[10px] border-[3px] border-white"
              :style="{ transform: team.skew }"
            ></div>
            <p
